...
export class InvariantChecker {
  ...
  static compareSnapshots(a: SlabSnapshot, b: SlabSnapshot): InvariantResult[] {
    ...
    // Engine state comparison (numUsedAccounts, numUsedAccounts are in engine)
    results.push({
      name: "D2: Engine accounts match",
      passed: a.engine.numUsedAccounts === b.engine.numUsedAccounts &&
              a.engine.numUsedAccounts === b.engine.numUsedAccounts,
      expected: `numUsed=${a.engine.numUsedAccounts}, nextId=${a.engine.numUsedAccounts}`,
      actual: `numUsed=${b.engine.numUsedAccounts}, nextId=${b.engine.numUsedAccounts}`,
    });
