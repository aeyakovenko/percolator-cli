  ...
  program
    ...
    .action(async (opts, cmd) => {
      ...
      if (flags.json) {
        ...
        console.log(`Nonce:              ${output.header.nonce.toString()}`);
        console.log(`Mat Counter:        ${output.header.matCounter.toString()}`);
        ...
        console.log(`Max Staleness:      ${output.config.maxStalenessSecs.toString()} slots`);
        console.log(`Conf Filter:        ${output.config.confFilterBps.toString()} bps`);
